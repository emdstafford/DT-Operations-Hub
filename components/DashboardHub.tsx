...
function filteredEmail(data: HubData, start: string, end: string, supervisors: string[], contracts: string[], showCompanyRankings: boolean) {
...
export default function DashboardHub() {
  ...
  function printGaryReport() {
    const report = filteredEmail(data, start, end, selectedSupervisors, selectedContracts, isEntireReport);
