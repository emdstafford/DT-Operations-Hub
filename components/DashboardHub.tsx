...
export default function DashboardHub() {
  ...
  function printGaryReport() {
    ...
    printWindow.document.write(`<!doctype html><html><head><title>Gary Report ${start} to ${end}</title><style>@page{size:landscape;margin:.45in}body{margin:0;background:white}table{font-size:11px}h2,h3{break-after:avoid}thead{display:table-header-group}</style></head><body>${report.html}<script>window.onload=()=>{window.print()}<\/script></body></html>`);
