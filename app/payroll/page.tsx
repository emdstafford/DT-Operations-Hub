...
export default function PayrollPage() {
  return <main className="page-shell payroll-page">
    ...
    <PayrollAccessGate><div className="payroll-tools-grid">
      ...
      <Link className="panel payroll-tool-card" href="/payroll/timecards"><span>Timecard review</span><h2>Timecard Report</h2><p>Compare this pay period with the previous one and print by contract. Files stay in your browser.</p><strong>Open tool →</strong></Link>
