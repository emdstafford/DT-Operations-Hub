...
export default function PayrollPage() {
  return <main className="page-shell payroll-page">
    ...
    <PayrollAccessGate><div className="payroll-tools-grid">
      <article className="panel payroll-tool-card"><span>Timecard review</span><h2>Timecard Report</h2><p>Print timecards by contract and save hour summaries to compare payrolls.</p><div className="payroll-tool-links"><Link href="/payroll/timecards">Open import →</Link><Link href="/payroll/timecard-trends">Timecard comparisons →</Link></div></article>
