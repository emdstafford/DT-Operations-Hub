...
export default function PayrollPage() {
  return <main className="page-shell payroll-page">
    ...
    <PayrollAccessGate><div className="payroll-tools-grid">
      <Link className="panel payroll-tool-card" href="/payroll/timecards"><span>Timecard review</span><h2>Timecard Report</h2><p>Print this pay period’s timecards and hours by contract. Compare them with notes from the previous pay period.</p><strong>Open tool →</strong></Link>
